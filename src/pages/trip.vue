<template>
  <v-container class="py-6">
    ...
    <div v-else-if="tripDetail" class="trip-body">
                      ...
                      <v-row>
                        <v-col cols="12" md="6">
                          <div class="mb-4">
                            ...
                            <div class="text-body-2 text-grey-darken-1">{{ tripDetail.remarks.overview || '暂无概述' }}</div>
                          </div>
                          <div class="mb-4">
                            <div class="text-subtitle-2 font-weight-bold mb-1 text-grey-darken-2">
              ...
              <template v-else>
                <v-form v-model="formValid">
                  <v-row>
                    ...
                    <v-col class="py-2" cols="12">
                      <v-switch v-model="editForm.is_public" color="success" inset label="是否公开" />
                    </v-col>
...
:deep(.v-img__img) { object-fit: cover; }
.v-card { display: flex; flex-direction: column; }
.fill-height { height: 100% !important; }
.trip-body { display: flex; flex: 1; min-height: calc(100vh - 64px - 48px); }
.fireworks-wrap { position: relative; width: 100%; height: 140px; margin-top: 10px; border-radius: 12px; overflow: hidden; }
